...
<figure class="img-polaroid">
    <img alt="" src="<?php echo $this->getImgPath('third-party-plugins/contact-form-0.png'); ?>">
</figure>
...
<figure class="img-polaroid">
    <img alt="" src="<?php echo $this->getImgPath('third-party-plugins/contact-form-1.png'); ?>">
</figure>
