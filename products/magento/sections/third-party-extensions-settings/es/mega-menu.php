...
<strong>MegaMenu</strong> está incluido en la plantilla por defecto, se puede activar/desactivar en <strong>System > Configuration > MEGAMENU > Mega Menu</strong>.
...
<ol class="index-list">
	...
	<li>
		Para añadir un bloque estático a un menú desplegable, es necesario añadir el bloque estático en <strong>CMS > Static Blocks</strong> y una vez que se ha creado añadirlo al menú.
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/mega-2.jpg') ?>" alt="" /></figure>
	</li>
	<li>
		El módulo le permite añadir etiquetas a cualquier categoría. Puede hacerlo en el menú de categorías <strong>Catalog > Manage Categories</strong>.
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/mega-3.jpg') ?>" alt="" /></figure>
	</li>	
	<li>
		Para cambiar la cantidad de columnas en subcategorías necesita cambiar el valor del número de la columna de nivel en el menú <strong>Catalog > Manage Categories</strong>.
