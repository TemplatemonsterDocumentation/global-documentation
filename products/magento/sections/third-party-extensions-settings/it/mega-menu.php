...
<strong>MegaMenu</strong> è incluso di default nel template, ed è possibile disabilitarlo o abilitarlo andando su <strong>System > Configuration > MEGAMENU > Mega Menu</strong>.
...
<ol class="index-list">
	...
	<li>
		Per aggiungere un blocco statico a un menù a discesa, lo si deve aggiungere andando su <strong>CMS > Static Blocks</strong> e, una volta creato, aggiungerlo al menù.
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/mega-2.jpg') ?>" alt="" /></figure>
	</li>	
	<li>
		Il modulo permette di aggiungere etichette per ciascuna categoria. È possibile farlo andando sul menù categorie <strong>Catalog > Manage Categories</strong>.
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/mega-3.jpg') ?>" alt="" /></figure>
	</li>	
	<li>
		Per modificare il numero di colonne nelle sottocategorie dovrai modificare il valore Count della colonna Level sul menù <strong>Catalog > Manage Categories</strong>.
