...
<ol class="index-list">
	...
	<li>
		Der Block <strong>Contacts Map Settings</strong> zeigt die Karte nur auf der Kontaktseite an.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-1.jpg'); ?>" alt="" /></figure>
	</li>
	<li>
		Die beiden Sektionen haben die gleichen Einstellungen für das Aussehen der Karte.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-2.jpg'); ?>" alt="" /></figure>
	</li>
</ol>
