...
<table class="options-table">
	<tr>
		...
		<td>-</td>
		<td>on peut activer / désactiver le module.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Image width</strong></td>
		<td>-</td>
		<td>on peut définir la largeur de l'image principale de produit.</td>
	<tr>
		<td class="col-1"><strong>Image height</strong></td>
		<td>-</td>
		<td>on peut définir la hauteur de l'image principale de produit. </td>
	</tr>
	<tr>
		<td class="col-1"><strong>Thumbnail width</strong></td>
		<td>-</td>
		<td>on peut définir la largeur de la vignette de produit.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Thumbnail height</strong></td>
		<td>-</td>
		<td>on peut définir la hauteur de la vignette de produit.</td>
	</tr>
</table>
<p>Nota Bene! La largeur maximale de l'image est égale à la largeur de la colonne où elle est placée. </p>
