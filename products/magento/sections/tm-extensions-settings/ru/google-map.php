...
<ol class="index-list">
	...
	<li>
		Блок <strong>Contacts Map Settings</strong> отвечает за вывод карты непосредственно на странице контактов.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-1.jpg'); ?>" alt="" /></figure>
	</li>
	<li>
		Обе секции имеют одни и те же опции для настройки внешнего вида карты.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-2.jpg'); ?>" alt="" /></figure>
	</li>
</ol>
