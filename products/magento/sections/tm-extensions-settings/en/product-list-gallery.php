...
<table class="options-table">
	<tr>
		...
		<td>-</td>
		<td>one can enable/disable the module.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Image width</strong></td>
		<td>-</td>
		<td>one can set the product main image width. </td>
	</tr>
	<tr>
		<td class="col-1"><strong>Image height</strong></td>
		<td>-</td>
		<td>one can set the product main image height. </td>
	</tr>
	<tr>
		<td class="col-1"><strong>Thumbnail width</strong></td>
		<td>-</td>
		<td>one can set the product thumbnail image width.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Thumbnail height</strong></td>
		<td>-</td>
		<td>one can set the product thumbnail image height.</td>
	</tr>
</table>
<p>Attention! The maximum image width is equal to the width of the column where it is placed. </p>
