<h3>Google Map</h3>
<p>The given module allows you to embed the Google map to your Magento website. By default, module provides you with two maps: the map on the contact page and the map in the footer of other pages.					
...
<ol class="index-list">
	...
	<li>
		<strong>Contacts Map Settings</strong> block stands for the display of the map directly on the contact page.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-1.jpg') ?>" alt="" /></figure>
	</li>
	<li>
		Both sections have the same options for configuring the appearance of the map.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/googlemap-2.jpg') ?>" alt="" /></figure>
	</li>
</ol>
...
<table class="options-table">
	...
	<tr>
		...
		<td>-</td>
		<td>switching geolocation on and off.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>-</td>
		<td>allows you to add the marker to the map.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>-</td>
		<td>text which will be displayed in the tool-tip while hovering over it.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Marker image</strong></td>
		<td>-</td>
		<td>path to the marker image, if you want to replace the default one. The image is saved in the folder <strong>skin/frontend/default/themeXXX/images/</strong> of your Magento installation.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>Infowindow</strong></td>
		<td>-</td>
		<td>additional information which will be displayed if you click the marker.</td>
	</tr>
</table>
