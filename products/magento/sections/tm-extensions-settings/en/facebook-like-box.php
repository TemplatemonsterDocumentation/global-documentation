...
<p>By default, the module is displayed in the left column. But there are three display options: <strong>left</strong>, <strong>right</strong> and <strong>footer</strong>.
	In order to change the position of the block, you need to open the <strong>tm_facebook.xml</strong> file located in the <strong>app/design/frontend/default/themeXXX/layout</strong> folder of your installation.</p>
...
<p>Now the Facebook block will be displayed in the footer.</p>
