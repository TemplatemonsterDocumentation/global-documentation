...
<ol class="index-list">
	<li>PhpMyAdmin e giriş yapın ve Öagento Commerce için kullanacağınız veritabanını seçin (Daha önceki adımlarda tarafınızdan kurulmuştur).<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-1.jpg') ?>" alt="" /></figure></li>
	<li>Şimdi <strong>"İçe aktar"</strong> a basın ve <strong>"Ara"</strong> ya tıklayın.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-2.jpg') ?>" alt="" /></figure></li>
	<li>Şablonunuzdaki <strong>"/sources/sample_data"</strong> klasörünü bulun ve <strong>dump.sql.gz</strong> dosyasını seçin. Ardından <strong>"GİT"</strong> e tıklayın. <figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-3.jpg') ?>" alt="" /></figure> İçe aktarma işlemi bir kaç dakika sürebilir.</li>
</ol>