...
<ol class="index-list">
	<li>Im Control Panel der Datenbank (PhpMyAdmin) wählen Sie die Datenbank, die Sie für die Installation Magento Commerce (Sie wurde erstellt, weil Sie die Aktionen in dem Schritt vorher ausgeführt haben) nutzen möchten.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-1.jpg'); ?>" alt="" /></figure></li>
	<li>Gehen Sie zum Tab <strong>"Import"</strong> und drücken Sie den Button <strong>"Browse"</strong>.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-2.jpg'); ?>" alt="" /></figure></li>
	<li>Gehen Sie in den Ordner <strong>"/sources/sample_data"</strong> Ihrer Vorlage und wählen Sie die Datei <strong>dump.sql.gz</strong>. Drücken Sie den Button <strong>"GO"</strong>. <figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/import-dump-3.jpg'); ?>" alt="" /></figure> Der Importprozess kann ein paar Minuten dauern.</li>
</ol>
