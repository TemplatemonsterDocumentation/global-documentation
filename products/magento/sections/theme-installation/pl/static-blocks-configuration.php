...
<ol class="index-list"> 
	...
	<li>Kliknij przycisk "Add New block" w prawym górnym rogu, aby dodać nowy blok.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg') ?>" alt="" /></figure></li>
