...
<ol class="index-list"> 
	<li>Otwórz panel administratora Magento i wybierz <strong>System > Configuration</strong> w górnym menu. <figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-8.jpg'); ?>" alt="" /></figure></li>
	<li>Wybierz zakładkę "<strong>Design</strong>". <figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-9.jpg'); ?>" alt="" /></figure>	</li>
