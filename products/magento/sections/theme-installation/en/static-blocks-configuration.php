...
<p>When you are done with configuring the pages, you need to configure the static blocks. The procedure is similar: you need to copy the code from the source files and paste it to the corresponding fields in the Magento admin panel. You need to use a similar table but for the static blocks.</p>
<ol class="index-list"> 
	<li>From the top menu select <strong>CMS > Static Blocks</strong>.</li>
	<li>Click the "Add New block" button in the right corner to add a new block.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg') ?>" alt="" /></figure></li>
...
<p>When you are done with configuring the store pages and blocks, your store is ready to go.</p>