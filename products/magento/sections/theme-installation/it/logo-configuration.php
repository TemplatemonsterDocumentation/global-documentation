...
<ol class="index-list"> 
	<li>Apri il pannello di amministrazione di Magento e vai su <strong>System > Configuration</strong> nel menù in alto.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-8.jpg') ?>" alt="" /></figure></li>
	<li>Seleziona la scheda "<strong>Design</strong>".<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-9.jpg') ?>" alt="" /></figure></li>
