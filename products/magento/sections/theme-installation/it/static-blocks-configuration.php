...
<ol class="index-list"> 
	<li>Dal menù in alto, seleziona  <strong>CMS > Static Blocks</strong>.</li>
	<li>Clicca sul pulsante "Add New Block" nell'angolo a destra per aggiungere un nuovo blocco.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg'); ?>" alt="" /></figure></li>
...
<p class="alert alert-info"><span>I file sorgente con il codice dei blocchi statici sono contenuti nella directory "<strong>sources\demo\static_blocks\</strong>" del pacchetto. </span></p>

<h4>Come visualizzare i blocchi con contenuto statico?</h4>

<ol class="index-list"> 
	<li>Andare su <strong>CMS > Widgets</strong> nel menu principale.</li>
