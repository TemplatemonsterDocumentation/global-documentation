...
<ol class="index-list"> 
	...
	<li>Drücken Sie den Button "Add New block" in der rechten oberen Ecke, um einen neuen Block hinzuzufügen. <figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg'); ?>" alt="" /></figure></li>
