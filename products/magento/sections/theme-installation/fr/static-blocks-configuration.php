...
<ol class="index-list"> 
	<li>Dans le menu du haut sélectionnez <strong>CMS > Static Blocks</strong>.</li>
	<li>Cliquez sur le bouton "Add New block" du coin droit pour ajouter un nouveau bloc.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg'); ?>" alt="" /></figure></li>
...
<ol class="index-list"> 
	<li>Accédez au <strong>CMS > Widgets</strong> dans le menu du haut.</li>
