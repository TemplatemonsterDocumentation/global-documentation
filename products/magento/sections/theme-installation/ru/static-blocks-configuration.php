...
<ol class="index-list"> 
	<li>В верхнем меню выберите <strong>CMS > Static Blocks</strong>. </li>
	<li>Нажмите кнопку <strong>"Add New block"</strong> в правом верхнем углу для добавления нового блока. 
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/pages-setting-5.jpg') ?>" alt="" /></figure>
	</li>
...
<ol class="index-list"> 
	<li>В верхнем меню выберите <strong>CMS > Widgets</strong></li>
	<li>Нажмите кнопку <strong>"Add New Widget Instance"</strong> в правом верхнем углу для добавления виджета.
	...
	<li>Укажите тип виджета <strong>CMS Static Block</strong>, тему к которой необходимо применить виджет и нажмите continue.
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/widget-2.jpg') ?>" alt="" /></figure>
	</li>
