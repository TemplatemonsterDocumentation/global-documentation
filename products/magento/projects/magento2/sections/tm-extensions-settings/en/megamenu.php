...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu.png', true) ?>" alt="" /></figure>
...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-1.png', true) ?>" alt="" /></figure>
...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-2.png', true) ?>" alt="" /></figure>
...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-3.png', true) ?>" alt="" /></figure>
...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-4.png', true) ?>" alt="" /></figure>
<p>Let’s consider columns’ settings.</p>
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-5.png', true) ?>" alt="" /></figure>
<ul class="marked-list">
	<li>
		<strong>Set column width</strong> - column width. It can take values from col-1 to col-12. 
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-7.png', true) ?>" alt="" /></figure>
	</li>
	<li>
		...
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-6.png', true) ?>" alt="" /></figure>
	</li>
	<li>
		...
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-8.png', true) ?>" alt="" /></figure>
	</li>
	<li>
		...
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-9.png', true) ?>" alt="" /></figure>
	</li>
	<li>
		...
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-11.png', true) ?>" alt="" /></figure>
	</li>
	<li>
		...
		<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-10.png', true) ?>" alt="" /></figure>
	</li>
</ul>
...
<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/menu-12.png', true) ?>" alt="" /></figure>
