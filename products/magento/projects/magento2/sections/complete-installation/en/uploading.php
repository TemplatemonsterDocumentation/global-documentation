...
<p>To start working with Magento you need to upload files to your hosting server. This can be done using your hosting file manager or some third party FTP manager.</p>
...
<ol class="index-list">
  ...
  <li>In the <strong>'Choose your zip file'</strong> select box please select the uploaded <strong>fullpackage.zip file</strong>.</li>
  <li>In the <strong>'Unzip to'</strong> field specify the directory where you want to extract the files.</li>
