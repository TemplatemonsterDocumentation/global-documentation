...
<ol class="index-list"> 
	<li>Otwórz stronę panelu administracyjnego Magento i w menu bocznym wybierz <strong>Sklepy > Konfiguracja</strong>.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-9.jpg', true) ?>" alt="" /></figure></li>
	<li>Wybierz kartę "<strong>Ogólne</strong>".<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-10.jpg', true) ?>" alt="" /></figure>		</li>
