...
<p class="alert alert-warning"><span>Block ID может отличаться в вашей установке. Вы можете взять корректный block id в секции Content-> Blocks в Admin panel.</span></p>
<ol class="index-list"> 
