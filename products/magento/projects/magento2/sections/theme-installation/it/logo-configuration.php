...
<ol class="index-list"> 
	<li>Aprire il pannello di amministrazione di Magento e selezionare <strong>Negozi > Configurazione (Stores > Configuration)</strong> nel menu laterale.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-9.jpg', true) ?>" alt="" /></figure></li>
	<li>Seleziona "<strong>Generale (General)</strong>" linguetta.<figure class="img-polaroid"><img src="<?php echo $this->getImgPath('magento/Theme-set-10.jpg', true) ?>" alt="" /></figure>		</li>
